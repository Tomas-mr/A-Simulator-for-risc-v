...
#define SLLI ((OPCODE == 0b0010011) && (FUNCT3 == 0b001) && ((imm_11_0>>5) == 0))
#define SRAI ((OPCODE == 0b0010011) && (FUNCT3 == 0b101) && ((imm_11_0>>5) == 0b100000))
#define SRLI ((OPCODE == 0b0010011) && (FUNCT3 == 0b101) && ((imm_11_0>>5) == 0))
...
#define shamt ((unsigned int)(imm_11_0 & 0x1f))
...
long INSN_SRLI(long pc) {
	int x = shamt;
	unsigned int xx = (unsigned int)(reg32[RS1]);
	if(RD)
		reg32[RD] = (int)(((unsigned int)(reg32[RS1])) >> ((unsigned int)shamt)); //逻辑右移，高位补0 
	return pc + 4;
}
